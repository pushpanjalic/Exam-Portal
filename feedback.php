...
<div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:700px;">
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2><br><br>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 

<p><h2>you can directly submit your feedback by filling the enteries below:-</h2></p>
